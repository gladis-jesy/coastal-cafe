...
describe('CartSidebarComponent', () => {
  ...
  beforeEach(async () => {
    cartServiceSpy = jasmine.createSpyObj('CartService', [
      ...
      cartItems: signal<CartItem[]>([mockItem]).asReadonly(),
      isCartOpen: signal(false).asReadonly(),
      cartTotal: signal(200).asReadonly()
    });
  ...
  it('should expose cartItems, cartTotal, and isOpen signals from CartService', () => {
